...
namespace Ects.Database
{
    internal class Program
    {
        ...
        private const string localConnectionString = "Server=(local)\\LOCALDEV; Database=ECTS; Trusted_connection=true";

        private const string azureConnectionString = "azure-db";

        private static readonly string ScriptRoot =
            Path.Combine(Path.GetDirectoryName(
                Assembly.GetExecutingAssembly().Location)!, "..", "..", "..", "Migrations");
