...
namespace Ects.Web.Api.Filters
{
    ...
    {
        private readonly Dictionary<HttpStatusCode, OpenApiResponse> _commonResponseCodes = new()
        {
        ...
        private readonly Dictionary<HttpStatusCode, OpenApiResponse> _updateResponseCodes = new()
        {
        ...
        private readonly Dictionary<HttpStatusCode, OpenApiResponse> _createResponseCodes = new()
        {
        ...
        private readonly Dictionary<HttpStatusCode, OpenApiResponse> _deleteResponseCodes = new()
        {
            [HttpStatusCode.NoContent] = new OpenApiResponse
            {
        ...
        private readonly Dictionary<HttpStatusCode, OpenApiResponse> _readResponseCodes = new()
        {
        ...
        public void Apply(OpenApiOperation operation, OperationFilterContext context)
        {
            static void ApplyDocumentation(Dictionary<HttpStatusCode, OpenApiResponse> codeMap, OpenApiOperation op)
            {
                foreach (var code in codeMap.Keys)
                {
                    ...
                    if (!op.Responses.ContainsKey(codeNum)) op.Responses.Add(codeNum, codeMap[code]);
                }
            }
