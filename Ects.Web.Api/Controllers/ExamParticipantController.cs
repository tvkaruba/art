...
namespace Ects.Web.Api.Controllers
{
    ...
    public class ExamParticipantController : ControllerBase
    {
        ...
        public ExamParticipantController(
        ...
        // GET: api/<ExamParticipantController>
        [HttpGet]
        ...
        // GET api/<ExamParticipantController>/5
        [HttpGet("{id}")]
        ...
        // POST api/<ExamParticipantController>
        [HttpPost]
        public void Post([FromBody] string value) { }

        // PUT api/<ExamParticipantController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value) { }

        // DELETE api/<ExamParticipantController>/5
        [HttpDelete("{id}")]
