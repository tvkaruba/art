...
namespace Ects.Web.Repository.Extensions
{
    /// <summary>
    /// Adds services and implements methods to use Microsoft Graph SDK.
    /// </summary>
    public static class MicrosoftGraphClientExtensions
    {
        /// <summary>
        ...
        {
            private IAccessTokenProvider Provider { get; }
            ...
            params string[] scopes)
        {
            ...
            services.AddScoped<IHttpProvider, HttpClientHttpProvider>(
                sp => new HttpClientHttpProvider(new HttpClient()));
            return services;
        }
    }
}